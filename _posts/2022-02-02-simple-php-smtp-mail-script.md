...
Pasting it here in case the repo ever disappears:
...
$mail = new Email('server.example.com', 587);
$mail->setProtocol(Email::TLS)
    ->setLogin('sender@example.com', 'SECRET')
...
[1]: https://github.com/snipworks/php-smtp/

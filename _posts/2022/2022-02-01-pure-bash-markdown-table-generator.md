...
tags: [bash, markdown, script]
---

I wanted a portable markdown table generator a few months back and threw
together `markdown-table`.

I initially just wanted to pass a bunch of arguments to the script along with
...
custom delimiters --- like CSV or TSV.
...
Or, accepts a TSV file like `test.tsv` with `markdown-table --tsv <
test.tsv`...

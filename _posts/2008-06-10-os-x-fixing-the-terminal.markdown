...
<a href="http://tech.inhelsinki.nl/gnu_developement_under_mac_os_x/">this article</a>
...
'Send string to shell:' as the action. **Note: Do not type the literal characters.
Use the delete one character button to delete the values there.**
